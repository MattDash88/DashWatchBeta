    ...
    render() {
        ...
        return (
            <main>                
                ...
                <p className="tpText">Voting for the Trust Protectors 2020 Elections is currently in progress, the voting app is available <a className="tpHowToLink" id="results" href={`https://tpe2020.dashwatch.org`}>Here</a>.</p>
